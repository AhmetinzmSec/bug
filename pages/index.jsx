    ...
    <>
      <div className="bg-neutral-800/10 shadow-xl rounded-lg w-full h-auto mt-6">
          <div className="relative">
                ...
                <p className="flex items-center text-white text-4xl font-semibold">
                  ...
                  <Tippy content={`Çevrimiçi`} animation="shift-away" arrow={false}>
                    <span className={`ml-2 text-online px-2 py-1 font-normal rounded-md text-sm`}>
                          <i className={`fa fa-circle text-online mr-2`} />Çevrimiçi
                    </span>
                  </Tippy>
            ...
            <br></br>
            <span style={{ zIndex: '-1' }} className="text-white/5 absolute bottom-3 left-7 text-xl sm:text-2xl md:text-4xl lg:text-3xl font-semibold">Geliştirici</span>
          </div>
      </div>


        <div className="py-20">
        <p className="text-3xl text-white font-semibold">GitHub Depoları</p>
            ...
            ? repositories
              ? repositories
                  ...
                  .map((_, __) => (
                    <a
                      key={__}
                      href={`https://github.com/AhmetinzmSec/`+_.name}
                      target="_blank"
                      rel="noreferrer"
